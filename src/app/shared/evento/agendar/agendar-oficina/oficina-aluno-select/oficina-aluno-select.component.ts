...
@Component({
	selector: 'app-oficina-aluno-select',
	standalone: false,
	templateUrl: './oficina-aluno-select.component.html',
...
export class OficinaAlunoSelectComponent implements OnChanges, OnDestroy {
