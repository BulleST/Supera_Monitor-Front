...
@Component({
	selector: 'app-oficina-evento-selected',
	standalone: false,
	templateUrl: './oficina-evento-selected.component.html',
	styleUrl: './../agendar-oficina.component.css'
})
export class OficinaEventoSelectedComponent implements OnChanges, OnDestroy {
	evento!: Evento;
	list: Evento[] = [];
	loading = false;
	readonly = false;
