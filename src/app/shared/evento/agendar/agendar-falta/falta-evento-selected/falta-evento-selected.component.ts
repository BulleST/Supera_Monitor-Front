...
@Component({
	...
	standalone: false,
	templateUrl: './falta-evento-selected.component.html',
	styleUrl: './falta-evento-selected.component.css'
})
export class FaltaEventoSelectedComponent implements OnChanges, OnDestroy {
	evento!: Evento;
	list: Evento[] = [];
	loading = false;
	readonly = false;
