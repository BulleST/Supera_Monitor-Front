...
@Component({
	selector: 'app-agendar-reposicao-confirm',
	standalone: false,
	templateUrl: './agendar-reposicao-confirm.component.html',
	styleUrl: './agendar-reposicao-confirm.component.css',
	providers: [ConfirmationService]
})
export class AgendarReposicaoConfirmComponent implements OnInit {
	...
	sendMensagemAluno(e: any) {
		...
		if (participacao.celular) {
			...
			this.confirmationService.confirm({
				target: e.target,
				message: `Reposição agendada com sucesso. <br> Clique para enviar mensagem de confirmação. <br> Celular: ${participacao.celular}`,
				...
				accept: () => {
					let object = this.mensagemWhatsapp.enviarMensagemReposicao(participacao.aluno, participacao.celular!, reposicaoDe, reposicaoPara);
