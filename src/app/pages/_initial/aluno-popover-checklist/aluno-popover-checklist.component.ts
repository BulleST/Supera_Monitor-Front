...
@Component({
    selector: 'app-aluno-popover-checklist',
    standalone: false,
    templateUrl: './aluno-popover-checklist.component.html',
    styleUrl: './aluno-popover-checklist.component.css'
})
export class AlunoPopoverChecklistComponent implements OnChanges, OnDestroy, AfterViewInit {
