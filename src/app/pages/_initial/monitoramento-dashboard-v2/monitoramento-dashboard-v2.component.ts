...
export class MonitoramentoDashboardV2Component implements OnDestroy {
  ...
  filterStatus = [
    ...
    { label: Dashboard_Item_Status.ReposicaoFalta, value: Dashboard_Item_Status.ReposicaoFalta, styleClass: 'bg-blue-600' },
    { label: Dashboard_Item_Status.FaltaNaAula, value: Dashboard_Item_Status.FaltaNaAula, styleClass: 'bg-red-500' },
    { label: Dashboard_Item_Status.FaltaAgendada, value: Dashboard_Item_Status.FaltaAgendada, styleClass: 'bg-red-500' },
    { label: Dashboard_Item_Status.ReposicaoPresente, value: Dashboard_Item_Status.ReposicaoPresente, styleClass: 'bg-green-300' },
