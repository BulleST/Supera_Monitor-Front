...
import { Dashboard_Request } from '../../../../models/dashboard-v2.model';

@Component({
  selector: 'app-filtro-popover-v2',
  standalone: false,
  templateUrl: './filtro-popover-v2.component.html',
  styleUrl: './filtro-popover-v2.component.css'
})
export class FiltroPopoverV2Component  implements OnDestroy, AfterViewInit {
