...
export class HomeComponent implements OnDestroy, AfterViewInit {
    ...
    agendarMenuItem: MenuItem[] = [ 
        { label: 'Aula', routerLink: 'calendario/agendar-aula' },
        { label: 'Superação', routerLink: 'calendario/agendar-superacao' },
        { label: 'Oficina', routerLink: 'calendario/agendar-oficina' },
        { label: 'Reunião', routerLink: 'aula/agendar-reuniao' } 
    ];

    jornadas: Roteiro[] = [];
    loadingJornada = false;

    currentJornada?: Roteiro;
    currentTitle = '';
