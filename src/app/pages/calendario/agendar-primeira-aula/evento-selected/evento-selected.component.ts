...
@Component({
	selector: 'app-evento-selected',
	standalone: false,
	templateUrl: './evento-selected.component.html',
	styleUrl: './evento-selected.component.css'
})
export class EventoSelectedComponent implements OnChanges, OnDestroy {
	evento!: Evento;
	list: Evento[] = [];
	loading = false;
	readonly = false;
