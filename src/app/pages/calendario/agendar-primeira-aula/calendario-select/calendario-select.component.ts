...
@Component({
	selector: 'app-calendario-select',
	standalone: false,
	templateUrl: './calendario-select.component.html',
	styleUrl: './calendario-select.component.css',
	providers: [ConfirmationService],
})
export class CalendarioSelectComponent implements OnChanges, OnDestroy {
